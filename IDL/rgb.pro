pro rgb
	...
	device,filename='GmRGB.eps',/encapsulated,/color,bits=8, $
		/helvetica,/isolatin1,$
		xoffset=0,yoffset=0,$
	...
	READCOL,'catalogs/h2knots_finale.txt',F=FMT,$
	...
	for k=0, last_star-1 do begin
			tvcross,10,star_x[k],star_y[k],color=white,thick=6,/DATA
	endfor
	
	device,/close
	;spawn,'/usr/local/bin/convert -quality 100 GmRGB.eps GmRGB.png; open GmRGB.png'
	set_plot,'x'
